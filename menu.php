...
if (isset($_SESSION["username"])) {
    ...
    <form class='navbar-form navbar-right' role='search' action='logout.php' method='post'>   
        ...
        <p class="posi2" style="font-size: 14px; position: relative; left: 35%; top: -5px;"><a href="logout.php" class="color" id='SignOut'>ออกจากระบบ</a></p>        
    </form> 
    </div>
    <?php } ?>
                    ...
                    <form id="login" method="post">
                        ...
                        <div class="modal-footer">
                            <div class="form-group" align="right">
                                <button type="submit" class="btn btn-default loginsubmit" value="submit" name="submit" id="submit" style="width: 120px;">Login
                                </button>
                            </div>
                        </div>
                    </form>
